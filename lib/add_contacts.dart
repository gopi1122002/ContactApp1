  ...
  Future<void> _saveContact() async {
    ...
    try {
      ...
      final newContact = Contact()
        ...
        ..phones = [Phone(_completePhoneNumber.trim(), label: PhoneLabel.mobile)];
                    ...
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                        ...
                        child: _selectedImage == null
                            ...
                            ? Icon(Icons.person, color: Colors.white, size: isSmallScreen ? 48.0 : 56.0)
                            : Text(
                    ...
                    Container(
                      ...
                      child: IntlPhoneField(
                        decoration: InputDecoration(
                          ...
                          fillColor: isDarkMode ? Colors.grey[850] : Colors.grey[200],
                          filled: true,
                          prefixIcon: const Icon(Icons.phone, size: 22, color: Colors.grey),
                        ),
